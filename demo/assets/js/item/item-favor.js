...
define(function (require, exports, module) {
     ...
     */
    function addFavor(param, justFavor, callback) {
     ...
     * @param node
     */
    function cancelFavor(param, callback) {
    ...
    function showQrDialog (json){
        ...
        var content = qrDialogTpl({
            ...
            top: "选择一位店员成为您的专属顾问",
            sub: "给店员扫描，您将获得以下服务：<br><em style='color: green'>[包邮]</em>收藏的商品可享有包邮服务<br><em style='color: green'>[留货]</em>收藏的商品可享留存三天服务<br><em style='color: green'>[专属]</em>将最适合您的商品推荐给您<br><em style='color: green'>[优惠]</em>将最新优惠第一时间与您同步"
        });
        !qrDialogNode ? (qrDialogNode = _qrDialog(content)) : qrDialogNode.setContent(content);
